...
builder.Services.AddScoped<IPetTypeService, PetTypeServices>();
builder.Services.AddScoped<IPetServicesService, PetServicesService>();
builder.Services.AddScoped<IAdoptablePetService, AdoptablePetService>();
